    ...
    return (
        <div className="relative form-control w-full font-text group">
            ...
            <input
                ...
                readOnly={readOnly}
                disabled={disabled}
                className={`w-full h-14 pl-4 ${rightElement ? 'pr-12' : 'pr-4'} bg-transparent rounded-xl relative z-10 text-base transition-all duration-300 outline-none placeholder:text-transparent
...
export const FloatingLabelSelect = ({ label, id, value, onChange, disabled, className = '', children, ...props }) => {
    ...
    return (
        <div className="relative form-control w-full font-text group">
            ...
            <Icon icon="lucide:chevron-down" className="absolute right-4 top-1/2 -translate-y-1/2 w-5 h-5 opacity-40 pointer-events-none z-20" />
